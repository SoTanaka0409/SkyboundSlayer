...

{
	...
	//奥
	{
		...
		mVertex[4].norm = VGet(1.0f, 0.0f, 0.0f);//後で計算する
		...
		mVertex[5].norm = VGet(1.0f, 0.0f, 0.0f);//後で計算する
		...
		mVertex[6].norm = VGet(1.0f, 0.0f, 0.0f);//後で計算する
		...
		mVertex[7].norm = VGet(1.0f, 0.0f, 0.0f);//後で計算する
