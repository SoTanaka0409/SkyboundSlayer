...
/// @brief 3人称視点カメラの更新処理
/// @details プレイヤー座標に基づく追従処理、コリジョン判定
...
/// @brief CameraのUpdateLookAtPosition処理
...
/// @brief CameraのUpdateCameraPosition処理
...
/// @brief マウス入力によるカメラ回転を更新するため
/// @details target_rot_の更新
...
/// @brief カメラの揺れ（シェイク）計算処理
/// @details 一時的なカメラ座標のオフセット
void Camera::Shake()
{
