	...
	LPSTR lpCmdLine, int nCmdShow)
{
	...
	//隰蜀怜愛陷磯メ・ｨ・ｭ陞ｳ螢ｹ・帝勳蜀怜愛鬮ｱ・｢邵ｺ・ｫ髫ｪ・ｭ陞ｳ螢ｹ笘・ｹｧ繝ｻ
	SetDrawScreen(DX_SCREEN_BACK);

	//Z郢晁・繝｣郢晁ｼ斐＜邵ｺ・ｫ隴厄ｽｸ邵ｺ蟠趣ｽｾ・ｼ郢ｧﾂ雋・摩・・
	...
	while (ProcessMessage() == 0 && CheckHitKey(KEY_INPUT_ESCAPE) == 0)
	{
		...
		//髯ｬ蜀怜愛鬮ｱ・｢邵ｺ・ｮ陷繝ｻ・ｮ・ｹ郢ｧ螳夲ｽ｡・ｨ騾包ｽｻ鬮ｱ・｢邵ｺ・ｫ隴擾ｿｽ邵ｺ繝ｻ
		ScreenFlip();

		//繝ｻ謇假ｽｼ蜉ｱﾎ醍ｹ晢ｽｪ驕俶慣・ｼ閧ｲ・ｧ蜻育・鬮｢讌｢・ｨ・ｳ繝ｻ蜴・ｽｼ闊後Ψ郢晢ｽｬ郢晢ｽｼ郢晢ｿｽ邵ｺ・ｽ邵ｺ・｣邵ｺ貅倪夢陜｣・ｴ陷ｷ闌ｨ・ｼ莉｣繝ｵ郢晢ｽｬ郢晢ｽｼ郢晢ｿｽ陟冶侭笳・ｹｧ鄙ｫ繝ｻ驍ｨ遒≫с隴弱ｋ菫｣
		//繝ｻ謇假ｽｼ蜉ｱﾎ醍ｹ晢ｽｪ驕俶慣・ｼ閧ｲ・ｧ蜻育・鬮｢讌｢・ｨ・ｳ繝ｻ蜴・ｽｼ闊後Ψ郢晢ｽｬ郢晢ｽｼ郢晉ｸｺ邵ｺ・｣邵ｺ貅倪夢陜｣・ｴ陷ｷ闌ｨ・ｼ莉｣繝ｵ郢晢ｽｬ郢晢ｽｼ郢晁冶侭笳・ｹｧ鄙ｫ繝ｻ驍ｨ遒≫с隴弱ｋ菫｣
		...
		//郢晢ｽｫ郢晢ｽｼ郢晏干笘・ｹｧ迢怜ｳｩ陷鷹亂竊鍋ｹｧ・ｷ郢晢ｽｼ郢晢ｽｳ鬩包ｽｷ驕假ｽｻ郢昶・縺臥ｹ昴・縺醍ｹｧ雋槭・郢ｧ蠕娯ｻ邵ｺ鄙ｫ・･
