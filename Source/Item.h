...
public:
    // 入力: なし / 出力: なし
    // 副作用: 未初期化のゴミデータによる不正なアイテム使用を防ぐため、安全な初期値（NONE等）をセットアップする
    Item();
