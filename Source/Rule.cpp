...
void Rule::Draw()
{
	...
	else if (mPage == 2)
	{
		...
		DrawFormatString(150, textY, GetColor(255, 255, 200), "[SHIFT]          ... ダッシュ"); textY += lineHeight;
		...
		DrawFormatString(150, textY, GetColor(255, 255, 200), "[ESC]            ... ポーズ / メニュー"); textY += lineHeight;
	}
