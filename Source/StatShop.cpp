...
void StatShop::Update()
{
	...
	// WALKING_OUT邵ｺｽｮ隴弱ｅ繝ｻ邵ｲ竏壹Ψ郢ｧｽｧ郢晢ｽｼ郢ｧｽｺ邵ｺ讙趣ｽｵ繧ｽｺ繝ｻｼ邵ｺｽｦ邵ｺ繝ｻ窶ｻ郢ｧ繧会ｽｧｽｻ陷榊供繝ｻ騾繝ｻｽ帝け螢ｹｿ郢ｧ蜿･ｽｿ繝ｻｽｦ竏壺ｲ邵ｺ繧ｽ狗ｸｺ貅假ｽ∫ｸｲ竏夲ｼ邵ｺ阮吶定崕繝ｻｽｲ闊鯉ｼ邵ｺｽｾ邵ｺ蜷ｶﾂ繝ｻ
...
void StatShop::movePosition()
{
	...
	if(model_) {
		...
		model_->Update(); // 縺薙％縺悟他縺ｰ繧後※縺縺ｪ縺九▲縺溘◆繧√√い繝九Γ繝ｼ繧ｷ繝ｧ繝ｳ(繝｢繝ｼ繧ｷ繝ｧ繝ｳ)縺碁ｲ縺ｾ縺ｪ縺九▲縺
	}
}
