...
{
    const float wallWidth = 4000.0f;//stage�̃T�C�Y
    const float wallDistance = 10000.0f;//stage�̃T�C�Y main
    ...
    new Player3D("Resource/Model/T.mv1", VGet(0.0f, 0.0f, 0.0f), 30.0f, 12.0f, 600.0f,true);//�W�����v�A�A�^�b�N�A�X�s�[�h�A����
   // new DinoTori("Resource/3D/tori/uploads_files_4895089_Sauros.mv1", VGet(-1800.0f, 800.0f, -240.0f), 15, 0.0f, 400.0f, 1.2f);//�g���P���g�v�X,hp,speed,Hitsize,size
      //new Dino2("Resource/3D/T_REX.mv1", VGet(400.0f, 300.0f, 800.0f), 10, 0.0f, 0.0f, 400.0f, 1.0f);//�X�s�� hp,speed,attack,Hitsize,size
...
void ResetScene::Update()
{
    ...
    if (player->GetStageOutFlag() == false)player->GetPosition() = player->GetOldPosition();//�ЂƂO�̏ꏊ�ɖ߂�
