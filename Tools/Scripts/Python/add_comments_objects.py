...
if __name__ == "__main__":
    basenames = [
        "Object2D", "Object3D", "ObjectManager",
        "Stage", "StageBox", "StageCollider", "StageObject",
        "Wall", "Tree", "Rock",
        "Collider", "ColliderManager", "CapsuleCollider", "SphereCollider", "Collision"
    ]
    
    cpps = [f"Source/{name}.cpp" for name in basenames]
    hs = [f"Source/{name}.h" for name in basenames]
